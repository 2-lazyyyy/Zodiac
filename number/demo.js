...
const dimensions = [
  ...
  // Define a regular expression that allows only letters (uppercase and lowercase) and spaces
  ...
  if (!regex.test(inputValue)) {
    // If the input does not match, remove invalid characters
    nameInput.value = inputValue.replace(/[^A-Za-z\s]/g, "");
  }
